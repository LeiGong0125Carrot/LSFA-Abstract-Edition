...
import random
import numpy as np
import cu_dataset, train, test
from optimizers import *
from model import Classifier, LSFL
from cu_transfer import collector, generator, transfer_model, transfer_train, transfer_data
import calibration
...
def main():
    ...
    #dataset
    parser.add_argument("--data_dir", default="/scratch/nkw3mr/ICD-SDoH-Classification/LSFA/data/SdohICD10", type=str,
    ...
    parser.add_argument('--valid_size', type=int, default=1600,
    ...
    parser.add_argument("--pretrained_path", default='/data/SdohICD10/model/lstm_20220818-141629.pth', type=str,
    ...
    parser.add_argument("--pre_feature_dict_path", default='/data/SdohICD10/model/feature_dict_20220818-135926.npy', type=str,
                        help="path of former feature dictionary")
    parser.add_argument('--pre_vaed', type=bool, default=False,
                        help="use pretrained VAE model")
    parser.add_argument("--pre_vaed_path", default='/data/SdohICD10/model/vae_20220818-141629.pth', type=str,
    ...
    parser.add_argument("--pre_calibrated_path", default='/data/SdohICD10/model/clf_20220809-131955.pth', type=str,
...
def da4mltc(args):
    ...
    train_loader, val_loader, test_loader, emb_init, mlb, args = cu_dataset.get_data(args)
